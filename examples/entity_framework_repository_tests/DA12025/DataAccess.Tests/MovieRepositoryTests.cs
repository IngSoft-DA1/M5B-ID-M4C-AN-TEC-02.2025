...
public class MovieRepositoryTests
{
    ...
    public void AddMovie_WhenCalledWithAnEmptyMovie_ThenThrowsException()
    {
        //arrange
        //act
    ...
    [TestMethod]
    [ExpectedException(typeof(DbUpdateException))]
    public void DeleteMovie_WhenCalledWithUndefinedMovie_ThenThrowsException()
    {
        //arrange
    ...
    [TestMethod]
    [ExpectedException(typeof(DbUpdateException))]
    public void UpdatMovie_WhenCalledWithDetachedMovie_ThenThrowsException()
    {
        //arrange
